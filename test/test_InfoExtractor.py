...
"thumbnail_url": "//www.nobelprize.org/images/12693-landscape-medium-gallery.jpg"
    ...
    def test_download_json(self):
        self.assertRaises(ExtractorError, self.ie._download_json, 'https://example.org/', None)
        self.assertEqual(self.ie._download_json('https://example.org/json', None, fatal=False), False)
        self.assertEqual(self.ie._download_json('https://example.org/', None, fatal=False), None)
