...
class VimeoIE(VimeoBaseInfoExtractor):
    ...
    _TESTS = [
        ...
        {
            # embed-only player URL with hash param for API shortcut
            'url': 'https://player.vimeo.com/video/764543723?h=f4a7f509ff&portfolio_id=1612641',
            'info_dict': {
                'id': '764543723',
                'ext': 'mp4',
                ...
                'description': 'md5:bd336dd2f44f91feb3695e15ef8cd165',
                'uploader': 'CADFEM',
                'uploader_id': 'cadfem',
                'uploader_url': 'https://vimeo.com/cadfem',
                'duration': 12505,
                'chapters': 'count:10',
                'timestamp': 1666874057,
                'like_count': int,
                'release_timestamp': 1666874057,
                'comment_count': int,
